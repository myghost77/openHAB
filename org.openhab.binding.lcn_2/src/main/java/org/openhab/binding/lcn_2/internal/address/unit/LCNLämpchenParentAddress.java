...
public class LCNLämpchenParentAddress extends BaseLCNUnitAddress {

    public LCNLämpchenParentAddress(final BaseLCNTargetAddress targetAddress, final int unitNr) {
