...
public class TempSensorBridge implements IAddressBindingBridge {

    public static TempSensorBridge getInstance() {
        return instance;
    }
    ...
    private TempSensorBridge() {
        // due to singleton
    }

    private static final TempSensorBridge instance = new TempSensorBridge();
}
