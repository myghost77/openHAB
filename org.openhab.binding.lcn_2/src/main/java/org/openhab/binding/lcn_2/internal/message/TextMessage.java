...
public class TextMessage extends BaseValueMessage<String> {

    public TextMessage(final IMessageKey messageKey, final String value) {
    ...
    public IMessage getCopy(final IMessageKey key) {
        return new TextMessage(key, value);
    }
}
