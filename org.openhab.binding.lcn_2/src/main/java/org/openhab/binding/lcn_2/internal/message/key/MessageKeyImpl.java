...
public class MessageKeyImpl extends BaseMessageKey {

    public MessageKeyImpl(final MessageType messageType, final IAddress address, final ValueType valueType) {
